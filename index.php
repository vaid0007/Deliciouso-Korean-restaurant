  ...
  <body class="body header-fixed main counter-scroll home1">
    ...
    <div id="wrapper">
      ...
      <section class="slider-page relative wow fadeIn" data-wow-delay=".3s">
        ...
        <div class="btn-next-product swiper-btn">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            version="1.1"
            xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 tr">
              <div class="swiper-container mySwiper1 visible">
      ...
      <section>
        <div class="container w_1650">
          <div class="row">
            <div class="col-md-12">
              <div
                class="gradient about-inner style1 radius-30 wow fadeIn"
                data-wow-delay=".2s"
              >
...
<p class="color-5">
  ...
  simple, and designed to get your food to you without any delays.
      ...
      <section class="tf-section tf-product pb-100">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div
                class="tf-title center pb-30 mb-76 wow fadeInUp"
                data-wow-delay=".2s"
              >
            ...
            <div class="col-md-12 wow fadeIn" data-wow-delay=".3s">
              <div class="swiper-container sl-product-2">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <a
                      href="assets/images/common/item_9.jpg"
                      class="gallery-img img flex"
                    >
                      <img src="assets/images/common/item_9.jpg" alt="" />
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a
                      href="assets/images/common/item_10.jpg"
                      class="gallery-img img flex"
                    >
                      <img src="assets/images/common/item_10.jpg" alt="" />
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a
        ...
        <div class="container w_1650">
          <div class="row">
            <div class="col-md-12">
              <div class="about-box">
                <img
                  class="icon-bg wow fadeIn"
                  data-wow-delay=".3s"
                  src="assets/images/backgroup/icon-bg.png"
                  alt=""
                />
                <img
                  class="icon-bg2 wow fadeIn move3"
                  data-wow-delay=".3s"
                  src="assets/images/backgroup/icon-bg2.png"
                  alt=""
                />
...
<p class="mb-22">
  ...
  unforgettable dining experience.
            ...
            <div class="col-md-12">
              <div class="counter_wrapper gradient">
                <div class="box wow fadeIn" data-wow-delay=".2s">
                  <div class="content">
                    <div class="box-couter counter">
                      <div class="number-content mb-18">
                        <span
                          class="count-number"
                          data-to="219"
                          data-speed="3000"
                    ...
                    <p class="desc">Orders Every Day</p>
                  </div>
                </div>
                <div class="box style wow fadeIn" data-wow-delay=".4s">
                  <div class="content">
                    <div class="box-couter counter">
                      <div class="number-content mb-18">
                        <span
                    ...
                    <p class="desc">Happy Customer</p>
                  </div>
                </div>
                <div class="box wow fadeIn" data-wow-delay=".6s">
                  <div class="content">
                    <div class="box-couter counter">
                      <div class="number-content mb-18">
                        <span
                    ...
                    <p class="desc">The Event Is Held</p>
                  </div>
                </div>
                <div class="box wow fadeIn" data-wow-delay=".8s">
                  <div class="content">
                    <div class="box-couter counter">
                      <div class="number-content mb-18">
                        <span
      ...
      <section class="tf-section pb-45">
        <div class="container w_1650">
          <div class="row">
            <div
              class="col-md-12 testimonial-wrapper style3 wow fadeIn"
              data-wow-delay=".3s"
            >
  ...
  <div class="testimonial-item">
    ...
    <p class="name color-3">
      ...
      <div class="hide-mobile">
        <img src="assets/images/backgroup/bg-section-3.jpg" alt="" />
      </div>
        ...
        <div class="container w_1920 pd0">
          <div class="row">
            <div class="col-md-12 flex items-center">
              <div class="wrap-banner flex items-center">
                <div class="image w-60 wow fadeIn" data-wow-delay=".3s">
                  <img
                    class="move3"
            ...
            <div class="col-md-12 wow fadeIn" data-wow-delay=".3s">
              ...
              >
                ...
                <div class="content">
                  ...
                  <p class="white">We promise not to spam your inbox.</p>
                </div>
                <div class="form">
                  <form action="#">
                    <input
