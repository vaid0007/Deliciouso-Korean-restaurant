    ...
    <div class="col-md-12">
          ...
          <div class="col-lg-8 col-md-12 tablet-mb-30 wow fadeIn" data-wow-delay=".3s">
            <div class="about-content relative radius-20 flex items-center justify-between">
              <img class="absolute l-0 t-0" src="assets/images/backgroup/layer_2.png" alt="" />
              <div class="inner-box style radius-20 mobile-mb-30">
                <img src="assets/images/common/item_35.png" class="mb-20" alt="" />
                <h2 class="white text-spacing-1 mb-6 italic">100%</h2>
                <h5 class="white text-spacing-0_5">Fresh Local Ingredients</h5>
              </div>
              <div class="content m--8 pl-15">
                ...
                <p class="mb-42">
                  At Korean Deliciouso, every plate celebrates the layers of flavor
                  that make Korean food so beloved — from delicate broths to bold
                  marinades. We carefully source local produce and premium proteins
          ...
          <div class="col-lg-8 col-md-12 wow fadeIn" data-wow-delay=".5s">
            <div class="about-content style1 relative radius-20 flex items-center justify-between">
              <img class="absolute r-0 t-0" src="assets/images/backgroup/layer_3.png" alt="" />
              <div class="content mobile-mb-30 mt--25">
                ...
                <p class="mb-20 pr-70">
                  Enjoy hot, flavorful Korean meals delivered quickly to your door
                  or prepared for convenient takeaway. We follow strict quality
                  controls so your meal arrives fresh and delicious.
                </p>
                <ul class="icon-list style3 w-full">
                  ...
                  <li class="style">
                    ...
                    <span class="color-3">Multiple Payment Options</span>
                  </li>
                </ul>
              </div>
              <div class="inner-box style2 gradient radius-20">
                <div class="image mb-10 flex justify-end">
                  <img class="w-167 ml-auto" src="assets/images/common/item_36.png" alt="" />
                </div>
  ...
  arrives fresh, hot, and on time—every single order.                          </p>
                    ...
                    <div class="swiper-slide">
                      <div class="box">
                        <div class="inner">
                          <div class="icon mb-28">
                            <svg id="Capa_2" enable-background="new 0 0 512.009 512.009" height="512"
                              viewBox="0 0 512.009 512.009" width="512" xmlns="http://www.w3.org/2000/svg">
                              <g>
                                <path
                    ...
                    <div class="swiper-slide">
                      <div class="box">
                        ...
                        <div class="hover-effect">
                          ...
                          <p class="color-5">
                            Quick and simple ordering — enjoy your favorite Korean dishes
                            with minimal wait.
                          </p>
                        </div>
                      </div>
...
<!-- Mirrored from themesflat.co/html/restaurant/fastfood/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Dec 2025 07:11:28 GMT -->
</html>
