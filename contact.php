            ...
            <div class="col-md-12">
              <div class="page-title-inner style2 hidden">
                <div class="bg-page-title-inner">
                  <img
                    class="parallax"
                    src="assets/images/backgroup/page-titled.jpg"
                    alt=""
                  />
                </div>
      ...
      <section class="tf-section pt-130 pb-0">
        <div class="container w_1650">
          <div class="row">
            <div class="col-md-12">
              <div
                class="gradient-7 about-inner style3 radius-30 wow fadeIn"
                data-wow-delay=".2s"
              >
                      ...
                      <div class="swiper-slide">
                        <div class="box">
                          <div class="inner">
                            <div class="icon mb-26">
                              <img
                                src="assets/images/icon/contact-us.png"
                                alt=""
                              />
                            </div>
      ...
      <section class="tf-section pb-130 pt-115 mobile-mb70">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div
                class="tf-title center pb-30 mb-50 wow fadeInUp"
                data-wow-delay=".2s"
              >
...
<!-- Mirrored from themesflat.co/html/restaurant/fastfood/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Dec 2025 07:12:30 GMT -->
</html>
