...
<head>
    ...
    <div class="content relative">
      ...
      <div class="flex">
        <ul class="flex items-center ml--20">
          <li class=" white">280 Gr / 720 Cal</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="product-box">
    <div class="overlay">
      <img
        class="radius-20"
        src="assets/images/common/slider_1.png"
        alt=""
      />
    </div>
    <div class="content relative">
  ...
  <div class="product-box">
    ...
    <div class="content relative">
      ...
      <div class="flex">
        <ul class="flex items-center">
          <li class="white">260 Gr / 680 Cal</li>
        </ul>
      </div>
    </div>
  </div>
              ...
              <div class="flat-tabs">
                <ul class="menu-tab flex w-full menu-item-box">
                  <li class="active">
                    <div class="item-box-2 style2">
                      <div class="image mb-10">
                        <img src="assets/images/common/item_22.png" alt="" />
                      </div>
                      <h6 class="center color-3 mb-0">Soulful Soups</h6>
                    </div>
                  </li>
                  <li>
                    <div class="item-box-2 style2">
                  ...
                  <li>
                    <div class="item-box-2 style2">
                      <div class="image mb-10">
                        <img src="assets/images/common/item_27.png" alt="" />
                      </div>
                      <h6 class="center color-3 mb-0">Kimbap(Sushi)</h6>
                    </div>
                  </li>
                </ul>
  ...
  <!-- Mirrored from themesflat.co/html/restaurant/fastfood/menu-restaurant.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Dec 2025 07:12:10 GMT -->
</html>
